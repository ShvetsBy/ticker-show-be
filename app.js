...
var finnhub_1 = require("@stoqey/finnhub");
var fastify_cors_1 = require("fastify-cors");
var server = (0, fastify_1["default"])();
server.register(fastify_cors_1["default"], {});
server.get('/ticker', function (request) { return __awaiter(void 0, void 0, void 0, function () {
    var ticker, finnHubKey, finnhubAPI, quote;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ticker = request.query.ticker;
                finnHubKey = process.env.KEY;
                finnhubAPI = new finnhub_1["default"](finnHubKey);
                return [4 /*yield*/, finnhubAPI.getQuote(ticker)];
            case 1:
                quote = _a.sent();
